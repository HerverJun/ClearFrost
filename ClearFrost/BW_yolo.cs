...
//
// 模块拆分:
//   - YoloPreprocessor.cs:  预处理模块 (Letterbox缩放、Tensor转换)
//   - YoloPostprocessor.cs: 后处理模块 (置信度过滤、坐标恢复)
//   - YoloNms.cs:           NMS 模块 (非极大值抑制)
//   - YoloRenderer.cs:      渲染模块 (结果可视化)
//   - YoloDataTypes.cs:     数据结构定义
//
